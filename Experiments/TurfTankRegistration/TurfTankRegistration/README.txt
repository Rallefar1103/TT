This is an experimental build of the TurfTankRegistration app, so as to create a barebones project (ie. some models, a view, and some testing)
It should be seen as a prototype and NOT the final build!
